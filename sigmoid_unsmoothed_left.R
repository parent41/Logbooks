...
write.table(as.numeric(model_c), paste("./sigmoid_fit/unsmoothed",args,"_model_c_left.txt", sep=""), sep = "", col.names = FALSE, row.names = FALSE)
write.table(as.numeric(model_ratio), paste("./sigmoid_fit/unsmoothed",args,"_model_ratio_left.txt", sep=""), sep = "", col.names = FALSE, row.names = FALSE)
write.table(as.numeric(model_c_log), paste("./sigmoid_fit/unsmoothed",args,"_model_c_left_log.txt", sep=""), sep = "", col.names = FALSE, row.names = FALSE)
